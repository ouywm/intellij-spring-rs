...
/**
 * RunLineMarker compatibility layer for platform version 233.
 *
 * In 233, the `elementType` extension property does not exist (must use node.elementType),
...
object RunLineMarkerCompat {
    ...
    fun createInfo(icon: Icon, actions: Array<AnAction>): RunLineMarkerContributor.Info {
        // In 233, Info constructor requires: (icon, tooltipProvider, actions...)
